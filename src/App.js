        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="glass-card bg-white/80 backdrop-blur-md p-8 rounded-3xl border border-gray-200 hover:shadow-2xl transition-all duration-300 hover:transform hover:scale-105">
              ...
              {currentLang === 'en' && (
                <>
                  <h3 className="text-2xl font-bold text-gray-800 mb-4">Dishwashers</h3>
                  <p className="text-gray-600 mb-6">Not cleaning or won't drain? We get your dishwasher running like new.</p>
                  <button className="bg-gradient-to-r from-orange-500 to-orange-600 text-white px-6 py-3 rounded-xl font-semibold hover:shadow-lg transition-all duration-300">
                    Request Service →
                  </button>
                </>
              ...
              {currentLang === 'ru' && (
                <>
                  <h3 className="text-2xl font-bold text-gray-800 mb-4">Посудомойки</h3>
                  <p className="text-gray-600 mb-6">Плохо моет или не сливает воду? Восстановим работу как новой.</p>
                  <button className="bg-gradient-to-r from-orange-500 to-orange-600 text-white px-6 py-3 rounded-xl font-semibold hover:shadow-lg transition-all duration-300">
                    Заказать ремонт →
                  </button>
                </>
              ...
              {currentLang === 'es' && (
                <>
                  <h3 className="text-2xl font-bold text-gray-800 mb-4">Lavavajillas</h3>
                  <p className="text-gray-600 mb-6">¿No limpia o no desagua? Hacemos que su lavavajillas funcione como nuevo.</p>
                  <button className="bg-gradient-to-r from-orange-500 to-orange-600 text-white px-6 py-3 rounded-xl font-semibold hover:shadow-lg transition-all duration-300">
                    Solicitar servicio →
                  </button>
                </>
            ...
            <div className="glass-card bg-white/80 backdrop-blur-md p-8 rounded-3xl border border-gray-200 hover:shadow-2xl transition-all duration-300 hover:transform hover:scale-105">
              <img 
                src="https://images.unsplash.com/photo-1565814329452-e1efa11c5b89?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" 
                alt="Range Repair" 
                className="w-full h-48 object-cover rounded-2xl mb-6"
              />
              {currentLang === 'en' && (
                <>
                  <h3 className="text-2xl font-bold text-gray-800 mb-4">Gas Ranges</h3>
                  <p className="text-gray-600 mb-6">Burner or ignition issues? We service all gas appliance problems safely.</p>
                  <button className="bg-gradient-to-r from-orange-500 to-orange-600 text-white px-6 py-3 rounded-xl font-semibold hover:shadow-lg transition-all duration-300">
                    Request Service →
                  </button>
                </>
              ...
              {currentLang === 'ru' && (
                <>
                  <h3 className="text-2xl font-bold text-gray-800 mb-4">Газовые плиты</h3>
                  <p className="text-gray-600 mb-6">Проблемы с конфорками или поджигом? Безопасно ремонтируем газовые приборы.</p>
                  <button className="bg-gradient-to-r from-orange-500 to-orange-600 text-white px-6 py-3 rounded-xl font-semibold hover:shadow-lg transition-all duration-300">
                    Заказать ремонт →
                  </button>
                </>
              ...
              {currentLang === 'es' && (
                <>
                  <h3 className="text-2xl font-bold text-gray-800 mb-4">Estufas de gas</h3>
                  <p className="text-gray-600 mb-6">¿Problemas con quemadores o encendido? Reparamos todos los problemas de gas de forma segura.</p>
                  <button className="bg-gradient-to-r from-orange-500 to-orange-600 text-white px-6 py-3 rounded-xl font-semibold hover:shadow-lg transition-all duration-300">
                    Solicitar servicio →
                  </button>
                </>
            ...
            <div className="glass-card bg-white/80 backdrop-blur-md p-8 rounded-3xl border border-gray-200 hover:shadow-2xl transition-all duration-300 hover:transform hover:scale-105">
              ...
              {currentLang === 'en' && (
                <>
                  <h3 className="text-2xl font-bold text-gray-800 mb-4">HVAC Systems</h3>
                  <p className="text-gray-600 mb-6">AC or heating not working? We repair residential and commercial HVAC systems.</p>
                  <button className="bg-gradient-to-r from-orange-500 to-orange-600 text-white px-6 py-3 rounded-xl font-semibold hover:shadow-lg transition-all duration-300">
                    Request Service →
                  </button>
                </>
              ...
              {currentLang === 'ru' && (
                <>
                  <h3 className="text-2xl font-bold text-gray-800 mb-4">Системы HVAC</h3>
                  <p className="text-gray-600 mb-6">Кондиционер или отопление не работает? Ремонтируем бытовые и коммерческие системы.</p>
                  <button className="bg-gradient-to-r from-orange-500 to-orange-600 text-white px-6 py-3 rounded-xl font-semibold hover:shadow-lg transition-all duration-300">
                    Заказать ремонт →
                  </button>
                </>
              ...
              {currentLang === 'es' && (
                <>
                  <h3 className="text-2xl font-bold text-gray-800 mb-4">Sistemas HVAC</h3>
                  <p className="text-gray-600 mb-6">¿El AC o la calefacción no funcionan? Reparamos sistemas HVAC residenciales y comerciales.</p>
                  <button className="bg-gradient-to-r from-orange-500 to-orange-600 text-white px-6 py-3 rounded-xl font-semibold hover:shadow-lg transition-all duration-300">
                    Solicitar servicio →
                  </button>
                </>
